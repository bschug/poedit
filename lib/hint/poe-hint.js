(function(mod) {
  ...
  var KEYWORDS = [
      'Show','Hide',
      'ItemLevel','DropLevel','AreaLevel','Quality','Sockets','LinkedSockets','Width','Height',
      'Rarity','Class','BaseType','SocketGroup','Identified','Corrupted','Replica',
      'ShaperItem','ElderItem','HasInfluence','ShapedMap','BlightedMap','MapTier','GemLevel','StackSize',
      ...
      'FracturedItem', 'SynthesisedItem', 'AnyEnchantment', 'HasEnchantment',
      'Continue'
  ];
  ...
  function getHintWords (cm, options) {
      ...
      if (['Identified','Corrupted','ElderItem','ShaperItem','ShapedMap','BlightedMap','FracturedItem','SynthesisedItem','AnyEnchantment'].indexOf( line[0].string ) >= 0) {
