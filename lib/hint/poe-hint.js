(function(mod) {
  ...
  var KEYWORDS = [
      ...
      'ShaperItem','ElderItem','ShapedMap','MapTier','GemLevel','StackSize',
  ...
  function getHintWords (cm, options) {
      ...
      if (['Identified','Corrupted','ElderItem','ShaperItem','ShapedMap','FracturedItem','SynthesisedItem','AnyEnchantment'].indexOf( line[0].string ) >= 0) {
